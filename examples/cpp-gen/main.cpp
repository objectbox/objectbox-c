...
public:
    TasklistCmdlineApp(obx::Store& store)
        : store(store), taskBox(store), unfinishedTasksQuery(taskBox.query(Task_::date_finished.equals(0)).build()) {}
...
protected:
    ...
    std::string fmtTime(int64_t timestamp) {
